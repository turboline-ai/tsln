...
**Installation:**
```bash
npm install @turboline/tsln
```

**Usage:**
```typescript
import { convertToTSLN, decodeTSLN } from '@turboline/tsln';
...
**Installation:**
```bash
go get github.com/turboline-ai/tsln-go
```

**Usage:**
```go
import "github.com/turboline-ai/tsln-go"

// Encode
data := []tsln.DataPoint{
    {Timestamp: "2025-12-27T10:00:00Z", Data: map[string]interface{}{"price": 50000}},
    {Timestamp: "2025-12-27T10:00:01Z", Data: map[string]interface{}{"price": 50125}},
}
...
fmt.Println(result.TSLN)                        // TSLN string
fmt.Println(result.Statistics.CompressionRatio) // 0.74 (74%)
fmt.Println(result.Statistics.EstimatedTokens)  // Token count

// Decode
decoded, err := tsln.DecodeTSLN(result.TSLN)
fmt.Println(decoded) // Original data
```
...
### Node.js/TypeScript
- **NPM Package:** [@turboline/tsln](https://www.npmjs.com/package/@turboline/tsln)
- **Repository:** [github.com/turboline-ai/tsln-node](https://github.com/turboline-ai/tsln-node)
- **Full Documentation:** [Format Specification](https://github.com/turboline-ai/tsln-node/blob/main/docs/README.md)
- **Issues:** [github.com/turboline-ai/tsln-node/issues](https://github.com/turboline-ai/tsln-node/issues)

### Go
- **Go Package:** [github.com/turboline-ai/tsln-go](https://github.com/turboline-ai/tsln-go)
- **Repository:** [github.com/turboline-ai/tsln-go](https://github.com/turboline-ai/tsln-go)
- **Full Documentation:** [Format Specification](https://github.com/turboline-ai/tsln-go/blob/main/docs/README.md)
- **Issues:** [github.com/turboline-ai/tsln-go/issues](https://github.com/turboline-ai/tsln-go/issues)
